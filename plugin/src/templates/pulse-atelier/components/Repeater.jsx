/**
 * Repeater — the editor control every Halo block with a list of items uses.
 *
 ...
 * packager compiles this design's editor bundle from `plugin/src/templates/halo/` alone,
