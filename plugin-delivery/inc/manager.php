...
function fm_delivery_screen(): void
{
    ...
    echo '<h2>Master designs</h2>';fm_delivery_form('upload');echo '<label>Compiled delivery ZIP <input type="file" name="bundle" accept=".zip" required></label>';submit_button('Add master design');echo '</form><table class="widefat striped"><thead><tr><th>Design</th><th>Version</th><th>Demo</th><th>Visibility</th></tr></thead><tbody>';
    $designs=get_posts(['post_type'=>'fm_design','post_status'=>'any','numberposts'=>-1]);
